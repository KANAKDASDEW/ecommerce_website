<?php
    ...
    if(!empty($_POST)){
      ...
      $insert="INSERT INTO cs_test_gallery(test_gallery_title,test_gallery_subtitle,test_gallery_image,serv_gastar_image)
            ...
            <form method="post" action="" enctype="multipart/form-data">
              <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8">
                              <h4 class="card_header_title"><i class="fa fa-gg-circle"></i>Upload Testimonials Information</h4>
                        </div>
                        <div class="col-md-4 text-right">
                            <a class="btn btn-sm btn-dark card_top_btn" href="test-all-banner.php"><i class="fa fa-th"></i> All Testimonials Banner</a>
                        </div>
