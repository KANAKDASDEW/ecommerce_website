<?php
    ...
    $id=$_GET['v'];
    $sel="SELECT * FROM cs_footer NATURAL JOIN cs_role WHERE user_id='$id'";
              ...
              <div class="card-header">
                  <div class="row">
                      ...
                      <div class="col-md-4 text-right">
                          <a class="btn btn-sm btn-dark card_top_btn" href="footer-all-user.php"><i class="fa fa-th"></i> All User</a>
                      </div>
