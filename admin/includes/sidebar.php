            ...
            <div class="col-md-2 sidebar_part">
              ...
              <div class="menu">
                  <ul>
                    ...
                    <li><a href="all-about-banner.php"><i class="fa fa-comments"></i> About Part</a></li>
                    <li><a href="service-all-banner.php"><i class="fa fa-comments"></i> Service Part</a></li>
                    <li><a href="test-all-banner.php"><i class="fa fa-comments"></i> Testimonials Part</a></li>
                    <li><a href="content-all-banner.php"><i class="fa fa-comments"></i> Content Part</a></li>

                    <li><a href="footer-all-banner.php"><i class="fa fa-comments"></i> Footer Part</a></li>
