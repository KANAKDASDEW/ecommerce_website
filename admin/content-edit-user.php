<?php
    ...
    $eid=$_GET['e'];
    $sel="SELECT * FROM cs_content WHERE content_id='$eid'";
    ...
    if(!empty($_POST)){
        ...
        $update="UPDATE cs_content SET content_title='$title', content_subtitle='$subtitle', content_details='$details',content_image='$imageName' role_id='$role' WHERE user_id='$id'";
        if(!empty($name)){
                ...
                <div class="card-body">
                   <div class="form-group row custom_form_group">
                      ...
                      <div class="col-sm-7">
                        ...
                        <input type="text" class="form-control" id="" name="name" value="<?= $data['content_title']; ?>">
                      </div>
                    </div>
                    <div class="form-group row custom_form_group">
                       <label class="col-sm-3 col-form-label">Subtitle:</label>
                       <div class="col-sm-7">
                         <input type="text" class="form-control" id="" name="phone" value="<?= $data['content_subtitle']; ?>">
                       </div>
                    </div>
                    <div class="form-group row custom_form_group">
                       <label class="col-sm-3 col-form-label">Detials:</label>
                       <div class="col-sm-7">
                         <input type="text" class="form-control" id="" name="phone" value="<?= $data['content_details']; ?>">
                       </div>
                    </div>
